...
function initCroper(){
    ...
    canvas = document.getElementById('model_imageCanvas');
    ...
    $('#model_imageCanvas').mousemove(function(e) { // binding mouse move event
    ...
    $('#model_imageCanvas').mousedown(function(e) { // binding mousedown event
        var canvasOffset = $(canvas).offset();
        iMouseX = Math.floor(e.pageX - canvasOffset.left);
        iMouseY = Math.floor(e.pageY - canvasOffset.top);
    ...
    $('#model_imageCanvas').mouseup(function(e) { // binding mouseup event
