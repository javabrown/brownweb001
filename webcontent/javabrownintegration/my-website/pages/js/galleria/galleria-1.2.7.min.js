 ...
 */ (function (a) {
    ...
    Galleria = function () {
        ...
        _createThumbnails: function () {
            ...
            var b, e, f, g, h, i, j = this,
                k = this._options,
                l = function () {
                    var a = j.$("thumbnails").find(".active");
                    return a.length ? a.find("img").attr("src") : !1
                }(),
                m = typeof k.thumbnails == "string" ? k.thumbnails.toLowerCase() : null,
                n = function (a) {
            ...
            }), h = e.split(":"), h.length == 2 && h[0] in v ? f.load("data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw%3D%3D", {
                height: f.data.height,
        ...
        _parseData: function () {
            ...
            return a.each(this._data, function (d, e) {
                ...
                if ("video" in e) {
                    var f = w(e.video);
                    if (f) {
                        c.iframe = v[f.provider].embed(f.id) +
                        function () {
        ...
        resize: function (c, d) {
            ...
            var e = this,
                f = this.$("container"),
                g = this._options.responsive == "aspect" && (!c.width || !c.height),
                h;
        ...
        if (i) {
            g(b);
            if (c) return;//throw new Error(d + ": " + b)
        } else if (c) {
            if (A) return;
        ...
        scale: function (c) {
            ...
            return E.wait({
                ...
                success: function () {
                    ...
                    }), a(d.container).width(f).height(g), c.canvas && B && (B.elem.width = d.width, B.elem.height = d.height, m = d.image.src + ":" + d.width + "x" + d.height, d.image.src = B.cache[m] ||
                    function (a) {
