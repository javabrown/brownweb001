...
<html lang="en">
	...
	<style>
		...
		*zoom:1; /* hasLayout ie7 trigger */
		...
		.div-bg1{
	   	  background-image: url(http://transparency-xbmc.googlecode.com/svn/trunk/media/DefaultAddonRepository.png);
			...
			<div class="row-fluid">
				...
				<div class="span3 well">
					...
					<ul class="nav nav-tabs nav-stacked">
						...
						<li style='margin:5px;'><a class='btn' href='services.php?ipage=rabbit-cipher'>iPages</a></li>
						<li style='margin:5px;'><a class='btn' href='services.php?ipage=rabbit-cipher'>iPages</a></li>
