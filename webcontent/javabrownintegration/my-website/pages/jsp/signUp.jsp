	      ...
	      <font size="2"><u>SignIn Please.</u></font>
             ...
             <script>
                function setColor(colorValue){
                  //alert(colorValue);
                  $('#signUpLink').css('color', colorValue);
                }
		   ...
		   $('#action_container_title').html("Login > Existing User");
		   $('#action_container').load('jsp/signIn.jsp',
		  	function()
		  	{
