...
<html lang="en">
	...
	<head>
		...
		<title>Java Brown Foundation - Online Services</title>
     
        <meta http-equiv="Content-type" content="text/html; charset=utf-8" />
        <meta name="description" content="Free Online Tools For Developers - Services|Online Encription|Online Code Formatters|Online Text Editors|URL Encoder/Decoder" />
        <meta name="keywords" content="Online, Formatters, Encription, Encoder, Decoder, Notepad, URL Encoder"/>
		...
		<div class="container-fluid page-container">
			<div class="row-fluid">
				...
				<div class="span3 well">
					...
					<h4><u>Utility Apps</u></h4>
				    <ul class="nav nav-tabs nav-stacked">
                        <li style='margin:5px;'><a class='btn' href='services.php?ipage=online-text-editor'>BrownPad</a></li>
                        <li style='margin:5px;'><a class='btn' href='trends.php'>jBrown Trends</a></li>
                        <!-- li style='margin:5px;'><a class='btn' href='services.php?ipage=webos'>WebOS</a></li-->		
                    </ul>               
				...
				<div class="span9 well" id="service-main-contant">
                    ...
                    <div id="individual-service-content" class="span12">
						<div class="span11 well ">
						  ...
						  <br/>
						  <center>
						     <img class="transparent1" src="images/OnlineServiceTools.jpeg" class="img-polaroid"/>
						  </center>   
						  <br/>
						  <p class="lead text-info well">We will add new tools on a regular basis, so be sure to add this site to your bookmarks.</p>
						  <br/>
		...
		<script>
						...
						$(document).ready(function () {
						   if(ipage == 'json-formatter'){
                             ...
                             //$('.transparent9').removeClass('transparent9');
                           }
						   ...
						   if(ipage == 'online-text-editor' ){
						      window.location=("service-definations/online-notepad/notepad.html");
						   }
						   if(ipage == 'webos' ){
						       $("#service-title").html("<h4>Web-OS process console!!</h4>");
						  	   $("#individual-service-content").load("service-definations/webos.html");						      
						   }
						   if(ipage == 'encoder_decoder' ){
						       $("#service-title").html("<h4>URL Encoder/Decoder</h4>");
						  	   $("#individual-service-content").load("service-definations/encoder-decoder.html");						      
						   }
                        });
