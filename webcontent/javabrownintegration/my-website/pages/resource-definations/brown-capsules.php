      ...
      <div class="tab-content">
         ...
         <div id="tab2" class="tab-pane active">
            <div class="well span11">
               <div class="github-widget" data-repo="javabrown/browncapsule"></div>
            </div>
         </div>
...
<script>
   function repo()
   {
        $('#git').repo({ user: 'javabrown', name: 'browncapsule' });
        //alert('done git');
   }
   
      repo();
      var aboutme_text = "BrownCapsule is an extension project of javabrown services. It's provide the backed capsule data to the associated project";
